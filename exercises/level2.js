...
function lvl2exercise3(num1, num2) {
	return num1 * num2;// Return the multiplication of num1 and num 2

}

function lvl2exercise4(num1, num2) {
	return num1/ num2;// Return the division of num1 and num2

}

function lvl2exercise5(num1) {
	return num1 += 2;// Add 2 to num1 using += and return it
